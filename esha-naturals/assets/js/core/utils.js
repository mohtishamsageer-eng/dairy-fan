...
(function (E) {
  ...
  E.utils = {
    $, $$, esc, money, discountPercent, param, getProduct, getCategory, productsIn,
    productUrl, categoryUrl, articleUrl, store, digits, whatsappUrl, telUrl,
    normalizePkPhone, readingTime, formatDate, reducedMotion, setMeta
  };
})(window.ESHA);
