...
(function (E) {
  ...
  E.pages.article = function (ctx) {
    ...
    <div class="container">
      <figure class="article-cover"><img src="${U.asset(a.cover)}" alt="${esc(a.coverAlt)}" width="720" height="480" fetchpriority="high"></figure>
    </div>
    <div class="section section--tight">
      <div class="container">
        ...
        ${
          products.length
            ? `<aside class="product-cta" aria-label="Products in this article">
    ...
    const more = E.articles
      .filter((x) => x.slug !== a.slug)
      .sort((x, y) => (y.topic === a.topic) - (x.topic === a.topic))
      .slice(0, 3);
