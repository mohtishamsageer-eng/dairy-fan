...
ESHA.faqs = function () {
  ...
  return [
    ...
    },
    {
      ...
      a: `<p>After you place your order, our team will call or message you to confirm it. Your order is then delivered within <strong>${d.timeText || '3–4 working days after confirmation'}</strong>.</p>`
    },
    {
